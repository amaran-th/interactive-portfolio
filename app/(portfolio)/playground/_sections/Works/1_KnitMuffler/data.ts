...
export const EASY_DRAFTS: Draft[] = [
  ...
  // 하트 — ivory(9) + pink(5) + yellow(3)
  {
    ...
    width: 10,
    data: [
      [9, 9, 9, 9, 9, 9, 9, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 5, 5, 9, 9, 9, 5, 5, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [5, 5, 5, 5, 9, 5, 5, 5, 5, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [5, 5, 5, 5, 5, 5, 5, 5, 5, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 5, 5, 5, 5, 5, 5, 5, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 5, 5, 5, 5, 5, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 5, 5, 5, 9, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 5, 9, 5, 9, 5, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 9, 9, 5, 5, 5, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 9, 9, 9, 5, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
    ],
  ...
  // 벌 — ivory(9) + yellow body(3) + black stripes/eyes(6) + blue wings(1)
  {
    ...
    data: [
      ...
      [1, 1, 9, 6, 3, 3, 6, 9, 1, 1].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [1, 1, 1, 3, 3, 3, 3, 1, 1, 1].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 6, 6, 6, 6, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [1, 1, 1, 3, 3, 3, 3, 1, 1, 1].map((c) => ({
      ...
      [1, 1, 9, 6, 6, 6, 6, 9, 1, 1].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 3, 3, 9, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 9, 9, 9, 9, 9, 9].map((c) => ({
  ...
  // 꽃 — ivory(9) + pink petals(5) + green stem(7)
  {
    ...
    data: [
      ...
      [9, 9, 5, 5, 5, 5, 5, 5, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 5, 5, 5, 5, 5, 5, 5, 5, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 5, 5, 5, 5, 5, 5, 9, 9].map((c) => ({
      ...
      [9, 9, 9, 7, 7, 7, 9, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 7, 9, 9, 9, 9, 9].map((c) => ({
        type: "V" as const,
        color: c as Color,
      })),
      [9, 9, 9, 9, 7, 9, 9, 9, 9, 9].map((c) => ({
