...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-12">
      {/* Background glow */}
      <div className="absolute left-1/2 top-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-cyan-500/10 blur-3xl sm:h-[460px] sm:w-[460px] lg:h-[600px] lg:w-[600px]" />
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center gap-6 text-center">
        ...
        <h1 className="bg-gradient-to-r from-white via-gray-200 to-gray-500 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl">
